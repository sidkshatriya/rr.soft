...
#define RR_AARCH64_PRELOAD_LOCALS_START 0x70010000
#define RR_AARCH64_CUSTOM_TICKS_ADDR (RR_PRELOAD_LOCALS_START + 1184)
#define RR_AARCH64_CUSTOM_TICKS_TARGET_ADDR (RR_PRELOAD_LOCALS_START + 1192)
#define RR_AARCH64_CUSTOM_ACCUM_TICKS_ADDR (RR_PRELOAD_LOCALS_START + 1200)
#define RR_AARCH64_CUSTOM_TARGET_REACHED_BREAK_ADDR                            \
  (RR_PRELOAD_LOCALS_START + 1208)
#define RR_AARCH64_CUSTOM_CNT_IN_CRITICAL_SECTION_ADDR                         \
  (RR_PRELOAD_LOCALS_START + 1212)
#define RR_AARCH64_CUSTOM_TRACE_TIME_ADDR (RR_PRELOAD_LOCALS_START + 1216)
#define RR_AARCH64_CUSTOM_REC_TID_ADDR (RR_PRELOAD_LOCALS_START + 1224)
...
#define RR_PRELOAD_LOCALS_START RR_AARCH64_PRELOAD_LOCALS_START
#define RR_CUSTOM_TICKS_ADDR RR_AARCH64_CUSTOM_TICKS_ADDR
#define RR_CUSTOM_TICKS_TARGET_ADDR RR_AARCH64_CUSTOM_TICKS_TARGET_ADDR
#define RR_CUSTOM_ACCUM_TICKS_ADDR RR_AARCH64_CUSTOM_ACCUM_TICKS_ADDR
#define RR_CUSTOM_TARGET_REACHED_BREAK_ADDR                                    \
  RR_AARCH64_CUSTOM_TARGET_REACHED_BREAK_ADDR
#define RR_CUSTOM_CNT_IN_CRITICAL_SECTION_ADDR                                 \
  RR_AARCH64_CUSTOM_CNT_IN_CRITICAL_SECTION_ADDR
#define RR_CUSTOM_TRACE_TIME_ADDR RR_AARCH64_CUSTOM_TRACE_TIME_ADDR
#define RR_CUSTOM_REC_TID_ADDR RR_AARCH64_CUSTOM_REC_TID_ADDR
